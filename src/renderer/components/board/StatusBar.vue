<template>
  <div class="status-bar">
    <span class="done-label">{{doneItemsCount}}</span> 已完成 |
    <span class="pending-label">{{pendingItemsCount}}</span> 进行中
    <span v-if="boardItems.length"><span class="progress-label">| {{progressCount}}</span>% 完成率</span>
  </div>
</template>
